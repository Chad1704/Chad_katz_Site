...
export default function TextEffect({ text, scrambleChars = ['.', ':', '-', '+', '*', '=', '%', '@', '#'], delayBetweenLetters = 40, frameDelay = 25 }) {
  ...
  return <span ref={wordRef} className="texteffect font-mono text-sm italic text-gray-400" />;
}